...
#define	LMTNW	20000000L  /* max. size of working area allowed  */
#define	NMAX	30000L    /* bound on ncol, order of A   	*/
#define	NZMAX	2000000L  /* bound on number of nonzeros in A   */
